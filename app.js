...
(function() {
  ...
  server = http.createServer(function(req, res) {
    var basename, dirname, isIgnore, number, params, pathname, user;
    isIgnore = false;
    ...
    if (basename.indexOf("postCommand") === 0) {
      ...
      return loginOrRegister(user, params.password, res);
