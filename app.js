...
(function() {
  ...
  server = http.createServer(function(req, res) {
    ...
    if (basename.indexOf("postCommand") === 0) {
      ...
      log("number=" + number);
      return fetchCommandFromNumber(token, number, res);
    } else {
