...
(function() {
  var COLLECTION_NAME, DOCROOT, S, authenticateUser, fs, getCommand, getHandler, http, log, mongo, mongoClient, mongoUri, port, postCommand, querystring, server, socketio, url, uuid, writeAsHtml;
